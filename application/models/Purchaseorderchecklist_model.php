...
class Purchaseorderchecklist_model extends CI_Model {
		...
		if(isset($data['where'])){
			foreach($data['where'] as $key => $value){
				switch($key){
					...
					case 'purchaseorder_vendor_id':
					case 'purchaseorder_vendor_company_name':
					case 'purchaseorder_project_name':
					case 'purchaseorder_user_id':
					case 'purchaseorder_status':
					case 'purchaseorder_commission_status':
					...
					case 'purchaseorder_vendor_id_like':
					case 'purchaseorder_vendor_company_name_like':
					case 'purchaseorder_project_name_like':
					case 'purchaseorder_user_id_like':
					case 'purchaseorder_status_like':
					case 'purchaseorder_commission_status_like':
					...
					case 'purchaseorder_vendor_id_noteq':
					case 'purchaseorder_vendor_company_name_noteq':
					case 'purchaseorder_project_name_noteq':
					case 'purchaseorder_user_id_noteq':
					case 'purchaseorder_status_noteq':
					case 'purchaseorder_commission_status_eq':
					...
					case 'purchaseorder_number_smalleq':
						...
						$this->db->where($thisField.' <=', urldecode($value));
						break;
					case 'purchaseorder_vendor_company_name_purchaseorder_vendor_name_like':
						$this->db->group_start()
							->like('purchaseorder_vendor_company_name', urldecode($value))
							->or_like('purchaseorder_vendor_name', urldecode($value))
						->group_end();
						break;
					case 'purchaseorder_default':
						...
						break;
					case 'purchaseorder_id_in':
					case 'purchaseorder_quotation_id_in':
						$thisField = str_replace('_in', '', $key);
