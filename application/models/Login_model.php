...
class Login_model extends CI_Model {
	...
	function get_role($data = array())
	{
		...
		/* query */
		$sql = "select role_id from role left join z_role_user on role_id = z_role_user_role_id left join user on z_role_user_user_id = user_id where role_deleted = 'N' and user_deleted = 'N'".$where;
		$query = $this->db->query($sql);
		return $query->result();
	}
