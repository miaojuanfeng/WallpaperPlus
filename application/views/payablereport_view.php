		...
		<div class="content-area">
			...
			<div class="container-fluid">
				<div class="row">
					...
					<h2 class="col-sm-12">Payable report</h2>
							...
							<div class="list-area">
								<form name="list" action="<?=base_url('purchaseorder/delete')?>" method="post">
									...
									<div class="page-area">
                                        ...
                                        <a href="<?=base_url('payablereport/export'.get_uri_string_parameters($this->uri->uri_string()))?>" class="btn btn-sm btn-primary pull-right" data-toggle="tooltip" data-original-title="Export">
