...
<html lang="en">
	<head>
		...
		function add_quotationitem_row(){
			...
			quotationitem_row += '<input id="quotationitem_product_code" name="quotationitem_product_code[]" type="text" class="form-control input-sm required abc" placeholder="Code" value="" />';
			quotationitem_row += '</div>';
													...
													<tr>
														<td>
															<div>
																...
																<input id="quotationitem_product_code" name="quotationitem_product_code[]" type="text" class="form-control input-sm required" placeholder="Code" value="<?=$value->quotationitem_product_code?>" />
															</div>
		...
		<div class="content-area">
			...
			<div class="container-fluid">
				<div class="row">
					...
					<div class="blue">
						<p>DONE: Quotation can manaually change status</p>
						<p>DONE: Search quotation number like (not from / to)</p>
						<p>DONE: When add / update quotation, select item process update一下, change color</p>
						<p>DONE: date field add date picker</p>
						<p>DONE: Old version cannot be re-version</p>
						<p>DONE: Edit old version quotation, every quotation keep in DB</p>
						<p>DONE: Add print button at "update page"</p>
