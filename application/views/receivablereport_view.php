							...
							<div class="list-area">
								<form name="list" action="<?=base_url('invoice/delete')?>" method="post">
									...
									<div class="page-area">
                                        ...
                                        <a href="<?=base_url('receivablereport/export'.get_uri_string_parameters($this->uri->uri_string()))?>" class="btn btn-sm btn-primary pull-right" data-toggle="tooltip" data-original-title="Export">
