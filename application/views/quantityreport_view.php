    ...
    <div class="content-area">
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <h2 class="col-sm-12">Quantity report</h2>
...
<!--                                                <div class="col-sm-2">-->
<!--                                                    <input type="text" name="purchaseorder_number_like" class="form-control input-sm" placeholder="SONo" value="" />-->
<!--                                                </div>-->
<!--                                                <div class="col-sm-2">-->
<!--															<span class="input-group date datetimepicker">-->
                        ...
                        <div class="list-area">
                            <form name="list" action="<?=base_url('salesorder/delete')?>" method="post">
                                ...
                                <div class="page-area">
                                    ...
                                    <a href="<?=base_url('quantityreport/export'.get_uri_string_parameters($this->uri->uri_string()))?>" class="btn btn-sm btn-primary pull-right" data-toggle="tooltip" data-original-title="Export">
