...
//			echo '$("table.list tbody tr:eq('.$this->input->post('thisRow').') input[name=\'quotationitem_product_type_name[]\']").val("'.get_type($thisData->product_type_id)->type_name.'");';
			...
			echo '$("table.list tbody tr:eq('.$this->input->post('thisRow').') textarea[name=\'quotationitem_product_detail[]\']").val("'.convert_nl('SIZE: '.get_product_size($thisData->product_id)->attribute_name.($thisData->product_repeat?'\nREPEAT: '.$thisData->product_repeat:'')).'").css("display", "none").fadeIn();';
...
//			echo '$("table.list tbody tr:eq('.$this->input->post('thisRow').') input[name=\'salesorderitem_product_type_name[]\']").val("'.get_type($thisData->product_type_id)->type_name.'");';
			...
			echo '$("table.list tbody tr:eq('.$this->input->post('thisRow').') textarea[name=\'salesorderitem_product_detail[]\']").val("'.convert_nl('SIZE: '.get_product_size($thisData->product_id)->attribute_name.($thisData->product_repeat?'\nREPEAT: '.$thisData->product_repeat:'')).'").css("display", "none").fadeIn();';
...
//			echo '$("table.list tbody tr:eq('.$this->input->post('thisRow').') input[name=\'purchaseorderitem_product_type_name[]\']").val("'.get_type($thisData->product_type_id)->type_name.'");';
			...
			echo '$("table.list tbody tr:eq('.$this->input->post('thisRow').') textarea[name=\'purchaseorderitem_product_detail[]\']").val("'.convert_nl('SIZE: '.get_product_size($thisData->product_id)->attribute_name.($thisData->product_repeat?'\nREPEAT: '.$thisData->product_repeat:'')).'").css("display", "none").fadeIn();';
...
//            echo '$("table.list tbody tr:eq('.$this->input->post('thisRow').') input[name=\'invoiceitem_product_type_name[]\']").val("'.get_type($thisData->product_type_id)->type_name.'");';
            ...
            echo '$("table.list tbody tr:eq('.$this->input->post('thisRow').') textarea[name=\'invoiceitem_product_detail[]\']").val("'.convert_nl('SIZE: '.get_product_size($thisData->product_id)->attribute_name.($thisData->product_repeat?'\nREPEAT: '.$thisData->product_repeat:'')).'").css("display", "none").fadeIn();';
...
//            echo '$("table.list tbody tr:eq('.$this->input->post('thisRow').') input[name=\'deliverynoteitem_product_type_name[]\']").val("'.get_type($thisData->product_type_id)->type_name.'");';
            ...
            echo '$("table.list tbody tr:eq('.$this->input->post('thisRow').') textarea[name=\'deliverynoteitem_product_detail[]\']").val("'.convert_nl('SIZE: '.get_product_size($thisData->product_id)->attribute_name.($thisData->product_repeat?'\nREPEAT: '.$thisData->product_repeat:'')).'").css("display", "none").fadeIn();';
	...
	public function quotationPaymentLoader()
	{
		...
		if($thisData){
			echo '<script>';
			echo 'function quotationPaymentLoader(){';
			echo '$("textarea[name=\"quotation_remark\"]").val("'.convert_nl($thisData->payment_remark_content).'").css("display", "none").fadeIn();';
			echo '$("textarea[name=\"quotation_payment\"]").val("'.convert_nl($thisData->payment_content).'").css("display", "none").fadeIn();';
			echo '}';
			echo '</script>';
		}
	}
